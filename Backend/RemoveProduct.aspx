<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RemoveProduct.aspx.cs" MasterPageFile="~/Backend.master" Inherits="Backend_RemoveProduct" %>
        ...
        <tr>
            ...
            <td><uc1:ctrl_Log ID="ctrl_Log1" runat="server" /> </td>
               ...
               <br />
                ...
                CellPadding="3" OnRowDeleting="RemoveBezra"  GridLines="Both" >
                <Columns>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GetBranches.aspx.cs" MasterPageFile="~/Backend.master" Inherits="Backend_GetBranches" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
   ...
   <table>
        ...
        <tr>
            <td class="style1"><h2>Branches:</h2></td>

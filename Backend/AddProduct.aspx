<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddProduct.aspx.cs" MasterPageFile="~/Backend.master" Inherits="Backend_AddProduct" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
   ...
   <table>
        ...
        <tr>
            <td class="style1"><h2>Add New Product</h2></td>
    ...
    <asp:Panel ID="Panel1" CssClass="eswed" runat="server" GroupingText="Product Data">
        <table width="100%">
            <tr >
                ...
                <asp:RequiredFieldValidator ForeColor="Red" ID="Req1" Enabled="true" Text="Required!" runat="server" ControlToValidate="txt_product_name"></asp:RequiredFieldValidator></td>
                <td >

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditPassword.aspx.cs" MasterPageFile="~/Backend.master" Inherits="Backend_EditPassword" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
   ...
   <table>
    ...
    <asp:Panel ID="Panel1" Width="900px" CssClass="eswed" runat="server" GroupingText="City Data">
        <table width="900px">
            <tr>
                <td>Name : 
